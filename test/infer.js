...
var cases = {
  ...
  'should return full name under not-so-obvious conditions': { input: 'nicolasbevacqua@gmail.com', expect: 'nicolasbevacqua' },
  'should return full name even if name comes last': { input: 'bevacquanicolas@gmail.com', expect: 'bevacquanicolas' },
  'should return bevacqua under abbreviations': { input: 'nico.bevacqua@gmail.com', expect: 'bevacqua' },
